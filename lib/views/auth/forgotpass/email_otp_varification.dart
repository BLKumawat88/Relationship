...
class EmailOTPVerificationForForgotPassword extends StatefulWidget {
  const EmailOTPVerificationForForgotPassword({
    super.key,
  });

  @override
  _EmailOTPVerificationForForgotPasswordState createState() =>
      _EmailOTPVerificationForForgotPasswordState();
}

class _EmailOTPVerificationForForgotPasswordState
    extends State<EmailOTPVerificationForForgotPassword> {
                      ...
                      InkWell(
                        onTap: () {
                          if (provider.userOtp == currentText) {
                            Navigator.pushNamed(context, "/generate_new_pass");
                          } else {
